<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLTransactions.aspx.cs" Inherits="DevelopmentTest.GLTransactions" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="card">
                <asp:GridView ID="GridViewGL" runat="server" AutoGenerateColumns="False" ShowHeader="True" GridLines="None">
                    <Columns>
                        <asp:BoundField DataField="Id" HeaderText="Id" ItemStyle-CssClass="num" />
                        <asp:BoundField DataField="Date" HeaderText="Date" DataFormatString="{0:d}" />
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <a href='GLTransactionDetail.aspx?id=<%# Eval("Id") %>' class="link-view">View</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <asp:Panel ID="PanelEmpty" runat="server" CssClass="empty" Visible="False">No GL transactions.</asp:Panel>
            </div>
        </div>
    </form>
</body>

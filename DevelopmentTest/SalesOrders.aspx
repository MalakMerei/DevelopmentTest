<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrders.aspx.cs" Inherits="DevelopmentTest.SalesOrders" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <h1>Sales Orders</h1>
            <div class="toolbar">
                <asp:HyperLink ID="LinkNewOrder" runat="server" NavigateUrl="~/NewOrder.aspx" CssClass="btn btn-primary">New order</asp:HyperLink>
            </div>
            <div class="card">
                <asp:GridView ID="GridViewOrders" runat="server" AutoGenerateColumns="False" ShowHeader="True" GridLines="None">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <a href="OrderDetail.aspx?id=<%# Eval("Id") %>" class="btn btn-primary">View</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                <asp:Panel ID="PanelEmpty" runat="server" CssClass="empty" Visible="False">No sales orders. Create one with &quot;New order&quot;.</asp:Panel>
            </div>
        </div>
    </form>
</body>
